  ...
  return (
    ...
    <div className="container d-flex align-items-center justify-content-center" style={{ height: '80vh' }}>
      {/* <div className="row"> */}
        ...
        marginRight: '10px'
        }} className=''><Link to='/PassengerLogin' style={{textDecoration: 'none', fontFamily: 'Arial, sans-serif', fontWeight: 'bold', width: '200px', 
       ...
       }} className=''><Link to='/PassengerRegistration' style={{textDecoration: 'none', fontFamily: 'Arial, sans-serif', fontWeight: 'bold', width: '200px', 
       borderRadius: '8px', color: 'white',
